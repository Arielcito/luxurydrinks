...
function singInTest() {
  describe("testeo de registro", function () {
    ...
    it("Ingreso credenciales incorrectas, sin subir archivo", async () => {
      ...
      await webDriver.findElement(By.css("#root > div.form.flex.justify-center.items-center > form > div.flex.m-4 > button.bg-red-600.hover\\:bg-red-700.font-semibold.py-3.px-5.mr-4.rounded-lg.btn.btn-primary")).click();
